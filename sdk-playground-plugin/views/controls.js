...
const docString = `### 🎛️ Реальный код макета Controls
...
export function getControlsDoc() {
  if (state.controlsCode) {
    return `### 🎛️ Настоящий код макета Controls
...
#### Исходный код файла (\`views/controls.js\`):
\`\`\`js
${state.controlsCode}
\`\`\`
`;
...
export function buildControlsCard() {
  ...
  if (state.showControlsCode) {
    childrenList.push(Markdown(getControlsDoc()));
    childrenList.push(Divider());
  }
