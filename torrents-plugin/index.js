...
PotokSDK.i18n.registerTranslations({
  en: {
    "potok-torrents": {
      ...
      config: {
        "name-category-searchEngine": "SearchEngine",
        "name-category-torrentGo": "TorrentGo",
        "name-category-dedup": "Deduplication",
        "name-category-cache": "Cache",
        "name-category-refresh": "Torrent refresh",
        "name-category-ffprobe": "Ffprobe",
        "name-category-proxy": "Proxy",
        "name-category-rutracker": "RuTracker",
        "name-category-animelayer": "AnimeLayer",
        "name-category-kinozal": "Kinozal",
        "name-category-otherTrackers": "Other trackers",
        ...
        ffprobeLogin: "Ffprobe login",
        ffprobePassword: "Ffprobe password",
        rutrackerEnableSearch: "RuTracker search",
        rutrackerLogin: "RuTracker login",
        rutrackerPassword: "RuTracker password",
        ...
        animelayerLogin: "AnimeLayer login",
        animelayerPassword: "AnimeLayer password",
  ...
  ru: {
    "potok-torrents": {
      ...
      config: {
        "name-category-searchEngine": "SearchEngine",
        "name-category-torrentGo": "TorrentGo",
        "name-category-dedup": "Дедупликация",
        "name-category-cache": "Кеш",
        "name-category-refresh": "Обновление торрентов",
        "name-category-ffprobe": "Ffprobe",
        "name-category-proxy": "Прокси",
        "name-category-rutracker": "RuTracker",
        "name-category-animelayer": "AnimeLayer",
        "name-category-kinozal": "Kinozal",
        "name-category-otherTrackers": "Прочие трекеры",
        ...
        proxyUrl: "URL прокси",
        proxyUsername: "Логин прокси",
        proxyPassword: "Пароль прокси",
        ffprobeLogin: "Логин ffprobe",
        ffprobePassword: "Пароль ffprobe",
        rutrackerEnableSearch: "Поиск RuTracker",
        rutrackerLogin: "Логин RuTracker",
        rutrackerPassword: "Пароль RuTracker",
        ...
        animelayerLogin: "Логин AnimeLayer",
        animelayerPassword: "Пароль AnimeLayer",
